...
import requests
import json
import re    # libreria de expresiones regulares (buscar patron)
...
#############################################################
# REDIRECCIONAMIENTO - PARTIDOS - (CRUD)
...
#############################################################
# REDIRECCIONAMIENTO - CANDIDATOS (CRUD)
...
def asignarPartidoACandidato(id,id_partido):
    data = request.get_json()
    headers = {"Content-Type": "application/json; charset=utf-8"}
    url = dataConfig["url-backend-resultados"] + '/candidatos/' + id + '/partido/' + id_partido
    response = requests.put(url, headers=headers, json=data)
    json = response.json()
    return jsonify(json)

#############################################################
# REDIRECCIONAMIENTO - RESULTADOS - (CRUD)
...
def eliminarResultado(id_resultado):
    headers = {"Content-Type": "application/json; charset=utf-8"}
    url = dataConfig["url-backend-resultados"] + '/resultados/' + id_resultado
    response = requests.delete(url, headers=headers)
    json = response.json()
    return jsonify(json)
...
def resultadosPorCandidato(id_candidato):
    headers = {"Content-Type": "application/json; charset=utf-8"}
    url = dataConfig["url-backend-resultados"] + '/resultados/candidato' + id_candidato
    response = requests.get(url, headers=headers)
    json = response.json()
    return jsonify(json)
...
def resultadosPorCandidatoPorMesa(id_candidato, id_mesa):
    headers = {"Content-Type": "application/json; charset=utf-8"}
    url = dataConfig["url-backend-resultados"] + '/resultados/candidato' + id_candidato + '/mesa/' + id_mesa
    response = requests.get(url, headers=headers)
    json = response.json()
    return jsonify(json)
...
def getMayorNumeroVotos():
    headers = {"Content-Type": "application/json; charset=utf-8"}
    url = dataConfig["url-backend-resultados"] + '/resultados/mayores_votaciones'
    response = requests.get(url, headers=headers)
    json = response.json()
    return jsonify(json)
...
# REDIRECCIONAMIENTO - USUARIOS - (CRUD)
...
# REDIRECCIONAMIENTO - USUARIOS-ROL
@app.route("/usuarios/<string:id_usuario>/rol/<string:id_rol>", methods=['PUT'])
def AsignarRolAUsuario(id_usuario , id_rol):
    headers = {"Content-Type": "application/json; charset=utf-8"}
...
# REDIRECCIONAMIENTO - PERMISOS - (CRUD)
...
def modificarPermiso(id):
    data = request.get_json()
    headers = {"Content-Type": "application/json; charset=utf-8"}
    url = dataConfig["url-backend-security"] + '/permisoss/' + id
    response = requests.put(url, headers=headers, json=data)
    json = response.json()
    return jsonify(json)
...
#############################################################
# REDIRECCIONAMIENTO - PERMISOSROLES
